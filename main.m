function [panorama]=main(filename)
    ...
    datasets={'imageset1'};%,'imageset2','imageset3'};
    ...
    %saving all images in single standard format: imageSet
...
%checks if the images are unordered, and orders them using SIFT features
    if unordered(which)
        t=cputime;
...
%creating the final panorama using techniques defined in documentation 
    panorama=create( imgs, f, full);
    
%writing final panorama to disk
