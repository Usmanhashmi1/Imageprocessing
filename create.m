...
t=cputime;
%start wrapping images into a 360 degress matrix
for i = 1 : nImgs
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%image translation and storing in translation list
...
if full360
    ...
    %managing the vertical drift in the cylinder 
...
t=cputime;
%final result stored in the newImg
